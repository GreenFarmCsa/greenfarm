...
class FocusSquare: SCNNode {
    ...
    private let focusSquareColor = UIColor(red: 0 / 255.0, green: 0 / 255.0, blue: 0 / 255.0, alpha: 0) // base yellow
    private let focusSquareColorLight =  UIColor(red: 0 / 255.0, green: 0 / 255.0, blue: 0 / 255.0, alpha: 0) // light yellow
